...
WiredMemoryAudioProcessorEditor::WiredMemoryAudioProcessorEditor (WiredMemoryAudioProcessor& p)
    : AudioProcessorEditor (&p),
      ...
      , envAttackAttachment  (*p.apvts.getParameter ("env_attack"),  envAttackRelay,  nullptr)
      , envDecayAttachment   (*p.apvts.getParameter ("env_decay"),   envDecayRelay,   nullptr)
      , envSustainAttachment (*p.apvts.getParameter ("env_sustain"), envSustainRelay, nullptr)
      , envReleaseAttachment (*p.apvts.getParameter ("env_release"), envReleaseRelay, nullptr)
...
void WiredMemoryAudioProcessorEditor::resized()
{
    ...
    if (webBrowser == nullptr)
    {
        ...
        auto options = juce::WebBrowserComponent::Options{}
            ...
            .withOptionsFrom (envAttackRelay)
            .withOptionsFrom (envDecayRelay)
            .withOptionsFrom (envSustainRelay)
